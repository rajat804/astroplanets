...
const CourseFormModal = ({
    ...
    const [formData, setFormData] = useState({
        ...
        duration: "",
        sessions: "",
        courseLanguage: "Hindi, English", // Changed from 'language' to 'courseLanguage'
        mode: "Live Online",
        price: "",
        rating: 0,
        image: "",
    ...
    const handleSubmit = async () => {
        try {
            ...
            // Clean data - remove empty array items and fix language field
            const cleanedData = {
                type: formData.type,
                ...
                courseLanguage: formData.courseLanguage, // Using courseLanguage instead of language
                mode: formData.mode,
